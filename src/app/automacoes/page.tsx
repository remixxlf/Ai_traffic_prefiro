  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white rounded-2xl border border-slate-200/80 p-6 shadow-sm">
        <div>
          <h1 className="text-xl font-bold text-slate-900 mb-1">Níveis de Automação & Guardrails</h1>
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div className="flex items-center space-x-2">
              ...
              <span className="font-semibold text-sm text-slate-900">Automações & Guardrails</span>
            </div>
          </div>
        </div>
      </header>
      ...
      <main className="p-4 sm:p-6 lg:p-8">
        <Suspense fallback={<div className="text-slate-500 text-center p-12 font-medium">Carregando configurações de automação...</div>}>
          <AutomacoesContent />
        </Suspense>
      </main>
    </div>
