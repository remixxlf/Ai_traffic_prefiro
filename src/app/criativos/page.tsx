      ...
      {empresaId ? (
        ...
        <div className="bg-white rounded-2xl border border-slate-200/80 p-12 text-center text-slate-500 shadow-sm max-w-xl mx-auto">
          ...
          <p className="text-xs text-slate-500 mb-4">
            Selecione uma empresa na página inicial para visualizar a biblioteca de criativos e diagnósticos de saturação.
          </p>
          <Link
            href="/"
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div className="flex items-center space-x-2">
              ...
              <span className="font-semibold text-sm text-slate-900">Biblioteca de Criativos</span>
            </div>
          </div>
        </div>
      </header>
      ...
      <main className="p-4 sm:p-6 lg:p-8">
        <Suspense fallback={<div className="text-slate-500 text-center p-12 font-medium">Carregando criativos...</div>}>
          <CriativosContent />
        </Suspense>
      </main>
    </div>
